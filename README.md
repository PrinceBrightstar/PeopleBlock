...
PeopleBlock is an open-source crowdsourced browser extension built upon the base work done by Sponsorblock to skip segments featuring specific people in YouTube videos. Users submit when a person is the main or one of the main focuses from the extension, and the extension automatically skips it. It also supports skipping other categories, such as intros, outros and reminders to subscribe.
